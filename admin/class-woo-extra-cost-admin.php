...
class Woo_Extra_Cost_Admin
{
    ...
    public function woo_extra_cost_product_save_data($post_id, $post)
    {
        ...
        if (isset($_POST['_extra_cost_enable'])) {
            update_post_meta($post_id, '_extra_cost_enable', sanitize_text_field( $_POST['_extra_cost_enable']) );
        } else {
            update_post_meta($post_id, '_extra_cost_enable', '');
        }

        if (isset($_POST['_extra_cost_enable_qty'])) {
            update_post_meta($post_id, '_extra_cost_enable_qty', sanitize_text_field( $_POST['_extra_cost_enable_qty']) );
        } else {
            update_post_meta($post_id, '_extra_cost_enable_qty', '');
        }

        if (isset($_POST['_extra_cost_label'])) {
            update_post_meta($post_id, '_extra_cost_label', sanitize_text_field( $_POST['_extra_cost_label']) );
        }

        if (isset($_POST['_extra_cost_amount'])) {
            update_post_meta($post_id, '_extra_cost_amount', sanitize_text_field( $_POST['_extra_cost_amount']) );
        }
        if (isset($_POST['_extra_cost_amount_quatity']) && !empty($_POST['_extra_cost_amount_quatity'])) {
            update_post_meta($post_id, '_extra_cost_amount_quatity', sanitize_text_field( $_POST['_extra_cost_amount_quatity'] ) );
            update_post_meta($post_id, '_extra_cost_enable_qty', '');
        }
        ...
        <div class="wrap about-wrap">
            ...
            <div class="about-text woocommerce-about-text">
                ...
                <img class="version_logo_img"
                     src="<?php echo plugin_dir_url(__FILE__) . 'images/woo-extra-cost.png'; ?>">
            </div>
    ...
    public function woocommerce_extra_cost_about()
    {
        ...
        <div class="changelog">
            ...
            <style type="text/css">
                p.woocommerce_extra_cost_overview {
                ...
                .woocommerce_extra_cost_content_ul ul li {
                    margin-left: 3%;
                    list-style: initial;
                    line-height: 23px;
                }
                    ...
                    <div>
                        ...
                        <div class="woocommerce_extra_cost_content_ul">
                            <ul>
                                ...
                                <li>Add country code and cost for that country to apply the extra cost to that
                                    country.
                                </li>
                            </ul>
                        </div>
    ...
    public function woocommerce_extra_cost_other_plugins()
    {
        ...
        <div class="plug-containter">
            <div class="paid_plugin">
                <h3>Paid Plugins</h3>
                <?php if (isset($get_other_plugin) && !empty($get_other_plugin) || $get_other_plugin != null) { ?>
    ...
    { ?>
        <div class="changelog">
            ...
            <div class="changelog about-integrations">
                <div class="wc-feature feature-section col three-col">
                    <div>
                        <p class="woocommerce_extra_cost_overview"><strong>Woocommerce Conditional Extra Fees</strong>
                        </p>
                        <p class="woocommerce_extra_cost_overview">Need even more? upgrade to <a
                                    href="https://codecanyon.net/item/woocommerce-save-for-later/17421044?s_rank=2"
                                    rel="nofollow">Woocommerce Conditional Extra Fees</a> and get all the features
                            available in Woocommerce Conditional Extra Fees</p>

                        <p class="woocommerce_extra_cost_overview"><strong>This plugin allows store owners to add extra
                                fixed charges/fees to the customer's order based on different conditions. You can
                                configure product specific, category specific, country specific or order amount specific
                                extra charges and it will be applicable to entire order. The charges will be added to
                                the cart total.</strong></p>


                        <p class="woocommerce_extra_cost_overview"><strong>List of conditional extra fees with
                                examples: </strong></p>

                        <div class="woocommerce_extra_cost_picture_entry_content">
                            <div class="woocommerce_extra_cost_premium_feature_list">
                                <p class="woocommerce_extra_cost_overview"><strong>Extra fees based on Country</strong>
                                </p>
                            </div>
                            <div class="woocommerce_extra_cost_feature_list">
                                <p class="woocommerce_extra_cost_overview">Using this feature you can charge Extra fees
                                    based on country. For example, you can charge extra cost based on "Country" like
                                    India= $5. Ex. If user purchase products from the India then extra $5 cost will be
                                    added to the cart total.</p>
                            </div>
                        </div>
                        ...
                        <div class="woocommerce_extra_cost_picture_entry_content">
                            <div class="woocommerce_extra_cost_premium_feature_list">
                                <p class="woocommerce_extra_cost_overview"><strong>Extra Fees based on User
                                        Role</strong></p>
                            </div>
                            <div class="woocommerce_extra_cost_feature_list">
                                <p class="woocommerce_extra_cost_overview">Using this feature you can charge Extra Cost
                                    based on User Role.(like Author,Subscriber). For example, if we select user role
                                    "author" = $30 extra cost. When "author" add product in to the cart then extra $30
                                    cost will be added to the total cart.</p>
                            </div>
                        </div>

                        <div class="woocommerce_extra_cost_picture_entry_content">
                            <div class="woocommerce_extra_cost_premium_feature_list">
                                <p class="woocommerce_extra_cost_overview"><strong>Extra Fees based Shipping
                                        Class</strong></p>
                            </div>
                            <div class="woocommerce_extra_cost_feature_list">
                                <p class="woocommerce_extra_cost_overview">Using this feature you can charge Extra Cost
                                    based on Shipping Classes. You can view all product shipping class here. For
                                    example, Let's say shipping class "Large" = $20 extra cost. When the customer adds
                                    "Large" shipping class product into the cart then extra $20 cost will be added into
                                    the cart.</p>
                            </div>
                        </div>
                        ...
                        <div class="woocommerce_extra_cost_picture_entry_content">
                            <div class="woocommerce_extra_cost_premium_feature_list">
                                <p class="woocommerce_extra_cost_overview"><strong>Remove All Extra Fees based on Max
                                        Total</strong></p>
                            </div>
                            <div class="woocommerce_extra_cost_feature_list">
                                <p class="woocommerce_extra_cost_overview">Using this feature you can remove all extra
                                    cost based on Maximum Cart Total Amount. For example, if we specify maximum cart
                                    total amount = $5000 and above then remove all extra cost. When customer cart total
                        ...
                        <div class="woocommerce_extra_cost_picture_entry_content">
                            <div class="woocommerce_extra_cost_premium_feature_list">
                                <p class="woocommerce_extra_cost_overview"><strong>Extra Fees based on Cart
                                        Total</strong></p>
                            </div>
                            <div class="woocommerce_extra_cost_feature_list">
                                <p class="woocommerce_extra_cost_overview">Using this feature you can charge Extra Cost
                                    based on maximum and minimum Cart Total value. For example, if we specify cart total
                                    value greater than or equal to (>=) $500 then charge Extra cost $20 and if cart
                                    total less than or equal to (>=) $100 then charge Extra cost $30. When the customer
                                    cart total amount is $500 and above then Extra $20 cost will be added to the cart
                                    total. OR if cart total amount is $100 and less then Extra $30 cost will be added to
                                    the cart total.</p>
                            </div>
                        </div>
                        ...
                        <div class="woocommerce_extra_cost_picture_entry_content">
                            <div class="woocommerce_extra_cost_premium_feature_list">
                                <p class="woocommerce_extra_cost_overview"><strong>Extra Fees based on Total Cart
                                        Quantity</strong></p>
                            </div>
                            <div class="woocommerce_extra_cost_feature_list">
                                <p class="woocommerce_extra_cost_overview">Using this feature you can charge Extra Cost
                                    based on maximum and minimum cart total quantity. For example, if we specify Cart
                                    Total Quantity greater than or equal to (>=) 20 then charge Extra cost $20 and if
                                    cart total Quantity less than or equal to (>=) 10 then charge Extra cost $10. When
                                    the customer cart total Quantity is 22 and above then Extra $20 cost will be added
                                    to the cart total. OR if cart total Quantity is 8 and less then Extra $10 cost will
                                    be added to the cart total.</p>
                            </div>
                        </div>
                        ...
                        <div class="woocommerce_extra_cost_picture_entry_content">
                            ...
                            <div class="woocommerce_extra_cost_feature_list">
                                <p class="woocommerce_extra_cost_overview">Using this feature you can charge Extra Cost
                                    based on maximum and minimum cart total weight. For example, if we specify Cart
                                    Total Weight greater than or equal to (>=) 500 lbs then charge Extra cost $50 and if
                                    cart total weight less than or equal to (>=) 300 lbs then charge Extra cost $20.
                                    When the customer cart total weight is 550 lbs and above then Extra $50 cost will be
                                    added to the cart total. OR if cart total weight is 250 lbs and less then Extra $20
                                    cost will be added to the cart total.</p>
                            </div>
                        </div>
                        ...
                        <div class="woocommerce_extra_cost_picture_entry_content">
                            <div class="woocommerce_extra_cost_premium_feature_list">
                                <p class="woocommerce_extra_cost_overview"><strong>Extra Fees based on Product</strong>
                                </p>
                            </div>
                            <div class="woocommerce_extra_cost_feature_list">
                                <p class="woocommerce_extra_cost_overview">Using this feature you can charge Extra Fees
                                    based on Product. you can see all product here. For example, if we select product
                                    "beach T-shirt" = $20 extra cost. When the customer adds "beach T-shirt" product
                                    into the cart then extra $20 cost will be added into the cart total.</p>
                            </div>
                        </div>
                        ...
                        <div class="woocommerce_extra_cost_picture_entry_content">
                            <div class="woocommerce_extra_cost_premium_feature_list">
                                <p class="woocommerce_extra_cost_overview"><strong>Extra Fees enable for Variable
                                        Product</strong></p>
                            </div>
                            <div class="woocommerce_extra_cost_feature_list">
                                <p class="woocommerce_extra_cost_overview">If variable Product is "Enable" then you can
                                    add "Extra Cost Message" and "Cost". When customer will add this product in to the
                                    cart at that time extra cost charge is automatically added in to cart total. For
                                    example, You have varitions for product with Red and Blue colour. if we specify Red
                                    = $10 and Blue= $20 extra charge. When customer will add "red color product" in to
                                    the cart and "extra $10 cost" will be added in the cart total.</p>
                            </div>
                        </div>

                        <div class="woocommerce_extra_cost_picture_entry_content">
                            <div class="woocommerce_extra_cost_premium_feature_list">
                                <p class="woocommerce_extra_cost_overview"><strong>Extra Fees based on Product
                                        Category</strong></p>
                            </div>
                            <div class="woocommerce_extra_cost_feature_list">
                                <p class="woocommerce_extra_cost_overview">Using this feature you can charge Extra Cost
                                    based on Product Category. you can view all category here. For example, if we select
                                    "Book" category = $30 extra cost. When the customer adds "xyz book" from book
                                    category into the cart then extra $30 cost will be added into the total cart.</p>
                            </div>
                        </div>
                        ...
                        <div class="woocommerce_extra_cost_picture_entry_content">
                            ...
                            <div class="woocommerce_extra_cost_feature_list">
                                <p class="woocommerce_extra_cost_overview">Using this feature you can charge Extra Cost
                                    based on Product Tag. you can view all product tag here. For example, if we specify
                                    Product Tag "SPECIAL011" = $15 extra cost. When the customer adds product with
                                    product tag "SPECIAL011" into the cart then extra $15 cost will be added to the
                                    total cart.</p>
                            </div>
                        </div>
                        ...
                        <div class="woocommerce_extra_cost_picture_entry_content">
                            <div class="woocommerce_extra_cost_premium_feature_list">
                                <p class="woocommerce_extra_cost_overview"><strong>Extra Fees on Particular
                                        Coupon</strong></p>
                            </div>
                            <div class="woocommerce_extra_cost_feature_list">
                                <p class="woocommerce_extra_cost_overview">Using this feature you can charge Extra Cost
                                    based on Product Coupon. you can view all coupons here. For example, if we specify
                                    Coupon "Code011" = $15 extra cost. When the customer apply coupon "Code011" into the
                                    cart then extra $15 cost will be added to the total cart.</p>
                            </div>
                        </div>
  ...
  Advance Extra Cost for WooCommerce</a>', 'my-text-domain'); ?></p></div>
    ...
    public function admin_notices_new_version_extra_cost()
    {
        ?>
        <div class="notice error not-dismissible">
            <p><?php echo 'WooCommerce Extra Cost has been <b style="color:red;">DISCOUNTINUED</b>.We have developed a better version of this plugin with more functionality and flexibility!<b style="color:red;"> New Free Version <a href="https://wordpress.org/plugins/woo-conditional-product-fees-for-checkout/ target="_blank">WooCommerce Conditional Product Fees for Checkout</a></b>'; ?></p>
        </div>
        <?php
    }
